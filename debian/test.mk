...
xpcshell-tests: export EXTRA_TEST_ARGS += --app-path=$(CURDIR)/build-cunaguaro/dist/bin
$(APP_TESTS): export EXTRA_TEST_ARGS += --appname=$(CURDIR)/build-cunaguaro/dist/bin/firefox
...
$(CURDIR)/build-cunaguaro/dist/bin/xulrunner:
	ln -s ../../../build-xulrunner/dist/bin $@

$(TESTS): $(CURDIR)/build-cunaguaro/dist/bin/xulrunner
